-- Table for storing credit card accounts
...
-- Table for storing credit card transactions
...
-- Seed initial credit card for default user (login_id 'teller' with user_id 3, or 'manager' with user_id 2, or 'admin' with user_id 1)
-- Let's add a card for testing purposes so there is something on start
...
-- Seed some transactions for the initial card
